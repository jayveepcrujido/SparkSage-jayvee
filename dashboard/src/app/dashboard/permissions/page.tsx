...
import { Loader2, Shield, ShieldAlert, Plus, Trash2, RefreshCw } from "lucide-react";
...
const COMMANDS = ["ask", "clear", "summarize", "review", "faq", "provider"];
...
export default function PermissionsPage() {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      setRoles(prev => ({ ...prev, [selectedGuild]: r.roles }));
      toast.success("Permissions and roles refreshed");
    } catch (err) {
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t">
                    ...
                    <div className="flex flex-wrap gap-1">
                      ...
                      {currentRoles.length > 10 && <span className="text-xs text-muted-foreground self-center">...</span>}
